(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var wsHttp = /** @class */ (function () {
        function wsHttp() {
            this.ws = null;
        }
        wsHttp.prototype.connect = function (WsOption) {
        ...
        wsHttp.prototype.send = function (data) {
            if (this.ws.readyState === WebSocket.CLOSED || this.ws.readyState === WebSocket.CLOSING) {
                return;
            }
            this.ws.send(data);
        };
        wsHttp.prototype.disconnect = function () {
            if (this.ws.readyState === WebSocket.CLOSED || this.ws.readyState === WebSocket.CLOSING) {
                return;
            }
            this.ws.close();
    ...
    var audioCtxt = /** @class */ (function () {
        function audioCtxt(audioOption) {
        ...
        audioCtxt.prototype.start = function () {
        ...
        // 录音阶段
        audioCtxt.prototype.record = function (callback) {
            var _this = this;
        ...
        // 重采样阶段
        audioCtxt.prototype.resample = function (buffer, sampleRate, callback) {
            this.resampleWorker.postMessage({
                command: 'record',
                buffer: buffer,
                sampleRate: sampleRate
            });
            this.resampleWorker.onmessage = function (e) {
        ...
        // 音频压缩阶段
        audioCtxt.prototype.speex = function (buffer) {
            var _this = this;
        ...
        audioCtxt.prototype.handleBuffer = function (buffer, sampleRate) {
        ...
        audioCtxt.prototype.manage = function () {
            this.record(this.handleBuffer.bind(this));
        };
        audioCtxt.prototype.stop = function () {
            this.recordStatus = false;
            // 终止所有的worker行为
    ...
    var Iat = /** @class */ (function () {
        ...
        Iat.prototype.start = function (startOption) {
            ...
            if (this.audioHandler) {
                ...
                // 启动麦克风
                this.audioHandler = new audioCtxt({ isResample: startOption.isResample || true, isSpeex: startOption.isSpeex, onAudioChunk: this.processAudioMessage.bind(this, startOption, iatPayload) });
            }
        };
        // 针对不同的阶段发送不同的请求
        Iat.prototype.send = function (startOption, iatPayload, type) {
            ...
            if (type === IATStatus.audioWrite) {
                ...
                for (var i = 0; i < output.length; i++) {
                    var view = new Int8Array(output[i]);
        ...
        // ws返回的结果处理过程
        Iat.prototype.processServerMessage = function (rpcResponseWrapper, startOption, iatPayload) {
            var rpcResponse = rpcResponseWrapper.result;
            if (!rpcResponse) {
                var error_1 = genError(Error.NO_RESPONSE, rpcResponseWrapper);
            ...
            if (ret !== 0) {
                ...
                var error_2 = genError(Error.RESPONSE_ERROR, rpcResponseWrapper);
            ...
            if (cmd === IATStatus.getResult) {
                if (this.status !== IATStatus.getResult) {
                    var error_3 = genError(Error.RESPONSE_ERROR, rpcResponseWrapper);
